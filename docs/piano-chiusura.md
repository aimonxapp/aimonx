...
| W4 | **WA4** | il contenuto del sito — le pagine del set minimo. ⭐ **La landing è costruita e su ramo, una sola**: tre varianti nel giro W4, la scelta del corpo nel W5, la parte alta rifatta nel W6 dal riferimento di Pier. Aspetta che Pier guardi; il merge è un giro suo. ⏳ Restano le altre pagine del set minimo, che sono `W5` e `W6` | P + CW scrivono, CC costruisce | ⭐ La catena tecnica era già in piedi: mancava il testo. ⛔ **E «costruita» non è «pubblicata»:** questa voce si chiude sul sito vero, come `WD23`, non sulla build |
