...
| W4 | **WA4** | il contenuto del sito — le pagine del set minimo. ⭐ **La landing è ONLINE dal giro W7**, autorizzata da Pier: tre varianti nel W4, la scelta del corpo nel W5, la parte alta dal riferimento nel W6, i tre ritocchi e il merge nel W7. ⏳ **La voce resta aperta:** il set minimo è di quattro pagine e ne è online una — restano le altre, che sono le righe `W5` e `W6` qui sotto | P + CW scrivono, CC costruisce | ⭐ La catena tecnica era già in piedi: mancava il testo. ⛔ **E «costruita» non è «pubblicata»:** questa voce si chiude sul sito vero, come `WD23`, non sulla build — ⭐ **la landing quel passo l'ha fatto, le altre tre pagine no** |
| W5 | **WA1 · WA2** | Privacy Policy e Support URL online. ⏳ **Costruite nel giro W9, NON online:** vivono su ramo, misurate, e aspettano il «pubblica» di Pier — ⛔ **prima del quale deve funzionare `support@aimonx.app`**, che è il solo contatto delle tre pagine e oggi passa ancora da Cloudflare | P + CW | ⛔ Senza queste due la submission dell'app non parte. Hanno bisogno di W4 per avere dove vivere |
| W6 | **WA3** | ✅ **la domanda è ACCERTATA** da Cowork il 22/09 su Apple: servono, perché Pro è un abbonamento auto-rinnovabile. ⏳ **Resta la pagina**, costruita nel giro W9 insieme alle altre due e in attesa dello stesso «pubblica» | CW ha accertato, CC ha costruito | ⛔ **La riga qui diceva ancora «due sezioni della fonte dicono cose diverse»** — ⭐ **e la risposta non stava nella fonte dell'app: stava in App Store Connect.** ⚠️ Era una domanda; ora che è sì, la pagina è un lavoro di W4, e infatti è stata fatta lì |
