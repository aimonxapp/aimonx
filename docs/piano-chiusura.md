...
**Costruito su [`docs/aperti.md`](aperti.md). Obiettivo: pubblicare le pagine che sbloccano la submission dell'app** — landing, Privacy Policy, pagina di supporto. ⭐ **Obiettivo RAGGIUNTO nel giro W9:** tutte e quattro sono online su `aimonx.app`. ⛔ **Resta in piedi `WA11`**, che però non blocca.
...
| W2 | **—** | ✅ **FATTA da Cowork il 22/09/2026:** `spec-sito.md` è riallineata a `~/Developer/AIMONX/docs/prodotto.md`. ⚠️ **La riga qui diceva ancora ⛔, e dal giro W9 non è più vero** | CW | ⭐ **Non è una voce del registro: è un lavoro fuori dal repo che deve accadere prima.** `spec-sito.md` è ferma a luglio e si fonda su `specifiche-aimonx.md`, che nel frattempo è diventata **archivio**; l'autorità viva su cosa fa l'app è `~/Developer/AIMONX/docs/prodotto.md`. ⛔ **Scrivere pagine contro una spec disallineata significa promettere funzioni che non ci sono** — è la trappola del sito |
...
| W4 | **WA4** | ✅ **FATTA nel giro W9.** Il contenuto del sito — le pagine del set minimo, **tutte e quattro online**. ⭐ **La landing è ONLINE dal giro W7**, autorizzata da Pier: tre varianti nel W4, la scelta del corpo nel W5, la parte alta dal riferimento nel W6, i tre ritocchi e il merge nel W7. ⭐ **E nel W9 le altre tre sono andate online con lei** (quinto e ultimo merge del set minimo, fast-forward `efdd8a5` → `ef7a2ff`) | P + CW scrivono, CC costruisce | ⭐ La catena tecnica era già in piedi: mancava il testo. ⛔ **E «costruita» non è «pubblicata»:** questa voce si è chiusa **sul sito vero**, come `WD23` e `WD26`, non sulla build — ⭐ **e la previsione ha tenuto per tutte e quattro le pagine, una dopo l'altra** |
| W5 | **WA1 · WA2** | ✅ **FATTE nel giro W9: Privacy Policy e Support sono ONLINE.** ⚠️ **E l'ordine è andato al contrario di come questa riga lo prevedeva:** diceva «prima deve funzionare `support@aimonx.app`», e **Pier ha deciso di pubblicare prima e spostare la posta dopo**. ⛔ La mail non è un controllo di CC: non è stata misurata qui | P + CW | ⛔ Senza queste due la submission dell'app non parte. Hanno bisogno di W4 per avere dove vivere |
| W6 | **WA3** | ✅ **FATTA nel giro W9**, tutta e due le metà: la domanda l'ha accertata Cowork il 22/09 su Apple — servono, perché Pro è un abbonamento auto-rinnovabile — e la pagina è **online** | CW ha accertato, CC ha costruito | ⛔ **La riga qui diceva ancora «due sezioni della fonte dicono cose diverse»** — ⭐ **e la risposta non stava nella fonte dell'app: stava in App Store Connect.** ⚠️ Era una domanda; ora che è sì, la pagina è un lavoro di W4, e infatti è stata fatta lì |
...
| **Il merge su `main` PUBBLICA** (Pages costruisce dalla radice di `main`) | ogni merge è un'autorizzazione di Pier, e va letto come «metto online», non come «salvo». ⭐ **Esercitato quattro volte — W3, W7, W8, W9 — sempre in fast-forward, mai un `--force`, e ogni volta con la build di Pages risultata identica al byte a quella locale.** ⭐ **La prima nel giro W3**, con l'autorizzazione di Pier del 22/09/2026 e su un sito ancora vuoto **apposta**: provare la build di Pages da sola, prima che `W4` ci aggiunga tema e pagine, perché una differenza fra build locale e build di Pages si vede solo se è l'unica incognita in campo. ⚠️ **L'autorizzazione valeva per quel merge**, non per i prossimi |
...
| **`WA1` e `WA2` hanno bisogno di un sito che esista** | W4 prima di W5. ⭐ **Il vincolo ha tenuto, e nel W9 le due cose sono successe nello stesso giro:** le pagine nuove sono nate dentro il sito che il W7 aveva messo online — stessa testata, stesso piede, stessi colori — e il piede della landing è cambiato con loro |
